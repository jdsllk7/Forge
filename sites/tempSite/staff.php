...
<body>
  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      <br><br>
      <h1 class="header center orange-text">School Personnel</h1>
      <div class="row center">
        <h5 class="header col s12 light">There are the academic personnel dedicated to fostering academic excellence.</h5>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="section">
      ...
      <div class="row">
        ...
        <?php
        $sql = "SELECT * FROM staff where user_id=" . $_COOKIE["user_id"];
        $result = mysqli_query($conn, $sql);
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="card medium">
              <div class="card-image">
                <img src="../../' . $row["staff_image"] . '" style="height:250px">
              </div>
              <div class="card-content">
                <span class="card_font"><b>NAME:</b> '.$row["staff_name"].'</span><br>
                <span class="card_font"><b>POSITION:</b> '.$row["staff_description"].'</span>
              </div>
            </div>
          </div>';
          }
