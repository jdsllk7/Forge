...
<body>
  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      <br><br>
      <h1 class="header center orange-text">Academic Calender</h1>
      <div class="row center">
        <h5 class="header col s12 light">Stay up to date with the school programs.</h5>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <table class="highlight striped centered">
          ...
          <tbody>
            ...
            <?php
            $sql = "SELECT * FROM calendar where user_id=" . $_COOKIE["user_id"];
            $result = mysqli_query($conn, $sql);
