...
<body>
  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      <br><br>
      <h1 class="header center orange-text">Grades & Subjects</h1>
      <div class="row center">
        <h5 class="header col s12 light">Here are the Grades and Subjects we offer</h5>
      </div>
    </div>
  </div>
    ...
    <div class="section">
      ...
      <div class="row">
        ...
        <div class="col s12 m4">
          <div class="card medium">
            <div class="card-image">
              <img src="8j.png" style="height:230px;width:100%">
            </div>
            <div class="card-content">
              <b>Grade 8</b>
              <?php
              $sql = "SELECT * FROM grades where user_id=" . $_COOKIE["user_id"] ." and grades like 'grade8'";
              $result = mysqli_query($conn, $sql);

              if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                  echo "<li>" . $row["subjects"] . "</li>";
                }
              }else{
                echo "<p>Sorry No subjects offered yet</p>";
              }
              ?>
            </div>
          </div>
        ...
        <div class="col s12 m4">
          <div class="card medium">
            <div class="card-image">
              <img src="9.jpg" style="height:230px;width:100%">
            </div>
            <div class="card-content">
              <b>Grade 9</b>
              <?php
              $sql = "SELECT * FROM grades where user_id=" . $_COOKIE["user_id"] ." and grades like 'grade9'";
              $result = mysqli_query($conn, $sql);
        ...
        <div class="col s12 m4">
          <div class="card medium">
            <div class="card-image">
              <img src="10.png" style="height:230px;width:100%">
            </div>
            <div class="card-content">
              <b>Grade 10</b>
              <?php
              $sql = "SELECT * FROM grades where user_id=" . $_COOKIE["user_id"] ." and grades like 'grade10'";
              $result = mysqli_query($conn, $sql);
        ...
        <div class="col s12 m4">
          <div class="card medium">
            <div class="card-image">
              <img src="11.jpg" style="height:230px;width:100%">
            </div>
            <div class="card-content">
              <b>Grade 11</b>
              <?php
              $sql = "SELECT * FROM grades where user_id=" . $_COOKIE["user_id"] ." and grades like 'grade11'";
              $result = mysqli_query($conn, $sql);
        ...
        <div class="col s12 m4">
          <div class="card medium">
            <div class="card-image">
              <img src="12.jpg" style="height:230px;width:100%">
            </div>
            <div class="card-content">
              <b>Grade 12</b>
              <?php
              $sql = "SELECT * FROM grades where user_id=" . $_COOKIE["user_id"] ." and grades like 'grade12'";
              $result = mysqli_query($conn, $sql);
