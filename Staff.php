...
<?php include 'db/validate_stuff.php'; ?>
...
<body class="grey lighten-4">
    ...
    <div class="row">
      <form class="col l6 push-l3 pull-l3" enctype="multipart/form-data" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <div class="input-field col s12">
          ...
          <label for="title" data-error="wrong" data-success="right">Name</label>
        </div>
        ...
        <div class="row">
          <div class="input-field col s12">
            ...
            <label for="desc" data-error="wrong" data-success="right">School Position</label>
          </div>
        </div>
  ...
  <div id="modal1" class="modal">
    <div class="modal-content">
      <h4 class="blue-text darken-2">Edit Staff Page</h4>
      <p>Please Note that by editing your Staff,<br>all your previous entries will be deleted<br>to make room for these new ones.</p>
    </div>
