...
<?php include 'db/validate_calender.php'; ?>
...
<body class="grey lighten-4">
		...
		<div class="row">
			<form class="col l6 push-l3 pull-l3" enctype="multipart/form-data" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
				<h4><?php if (isset($_SESSION["add"]) && $_SESSION["add"] > 0) {
						echo $_SESSION["add"] . ". ";
					} ?>Academic Calender</h4><br>

				<div class="input-field col s12">
					<!-- <i class="material-icons prefix">account_circle</i> -->
					<input type="text" class="validate" name="activity" id="activity">
					<label for="activity" data-error="wrong" data-success="right">Event Name</label>
				</div>



				<div class="input-field col s12">
					<input type="text" class="datepicker" name="activity_type" placeholder="Select Date">
				</div>
	...
	<div id="modal1" class="modal">
		<div class="modal-content">
			<h4 class="blue-text darken-2">Edit Calender Page</h4>
			<p>Please Note that by editing your Calender,<br>all your previous entries will be deleted<br>to make room for these new ones.</p>
		</div>
